...
local STEPS = {
    ...
    { fact = "cc_g02_lean_taken",       who = "SCENE",  what = "V is on the railing outside Yoko's. The script reads this, moves the world clock on by what is left of the half hour, and writes the release" },
    { fact = "cc_g02_lean_shift",       who = "GRAPH",  what = "asked for behind the black: the script moves the clock on by what is left of the half hour" },
    { fact = "cc_g02_lean_release",     who = "GRAPH",  what = "the scene ends and V stands up. Also written by the script if the beat passed while he was still in the pose" },
    { fact = "cc_g02_wait1_claim",      who = "GRAPH",  what = "which arm won the first wait. 1 = the clock ran out, 2 = the railing was taken" },
    ...
    { fact = "cc_g02_sit_taken",        who = "SCENE",  what = "V is in the chair outside the parlor door. Same shape as the railing, twenty minutes instead of thirty" },
    { fact = "cc_g02_sit_shift",        who = "GRAPH",  what = "asked for behind the black: the script moves the clock on by what is left of the twenty minutes" },
    { fact = "cc_g02_sit_release",      who = "GRAPH",  what = "the scene ends and V stands up. Also written by the script if the beat passed while he was still in the pose" },
    { fact = "cc_g02_wait2_claim",      who = "GRAPH",  what = "which arm won the second wait. 1 = the clock ran out, 2 = the chair was taken" },
