...
this file cannot show faithfully, because a graph is not a page.
    ...
    python .\tools\gig01\dump_dialogue.py [-o path] [--screens]
"""
import argparse
import ast
import os
...
def main():
    ...
    out.append('generator that builds it (tools/gig01/gen_scenes.py) by')
    out.append('tools/gig01/dump_dialogue.py. Do not edit this file - edit the')
